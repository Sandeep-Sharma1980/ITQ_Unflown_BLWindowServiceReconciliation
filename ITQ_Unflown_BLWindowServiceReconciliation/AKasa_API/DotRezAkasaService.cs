...
{
    public class DotRezAkasaService
    {
        string Connec = "";
        public DotRezAkasaService(string Conn)
        {
            Connec = Conn;
        }

        public static string AkasaPostJson(string url, string MethodType, string AccessToken, string Request, string Userid, string LogsTrackID = "", string TransactionProcess = "")
        {
            ...
            try
            {
                ...
                if ((MethodType == "POST" || MethodType == "PUT" || MethodType == "DELETE") && Request.Length > 1)
                {
            ...
            {
                DAL.InsertExceptionLogs("", "", "DotRezAkasaService.cs", "XMLResponsePost_AKasa", "Error", ex, "Exception occurred during calling AkasaPostJson method");
            }
            return responseXML;
        }
        ...
        public static string GetAccessToken(string TokenResponse)
        {
            ...
            {
                DAL.InsertExceptionLogs("", "", "DotRezAkasaService.cs", "TokenResponse_Akasa", "Error", ex, "Exception occurred during calling GetAccessToken method");
            }
            return Tokenid;
        }
